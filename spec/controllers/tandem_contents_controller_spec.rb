...
describe TandemContentsController do
  ...
  describe 'someone who cannot edit tandem content' do
    ...
    before do
      TandemPage.stub(:find).with('11').and_return(@tandem_page)
    end
    
    bar_actions([:get,    :index,   {:tandem_page_id => '11'}],
                [:get,    :show,    {:tandem_page_id => '11'}],
                [:get,    :new,     {:tandem_page_id => '11'}],
                [:get,    :edit,    {:tandem_page_id => '11'}],
                [:post,   :create,  {:tandem_page_id => '11'}],
                [:put,    :update,  {:tandem_page_id => '11'}],
                [:delete, :destroy, {:tandem_page_id => '11'}])
  end

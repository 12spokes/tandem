...
describe "Editing" do
  ...
  describe "basic text content" do
    it "changes the content", js: true do
      visit root_path
      edit_tandem_text_content(:tandem_sidebar, 'I love tandem!')

      within '#content_text_tandem_sidebar' do
        page.should have_content('I love tandem!')
      end
    end
  end

  describe "wysiwyg content" do
    it "changes the content", js: true do
      visit root_path
      edit_tandem_text_content(:tandem_text_block, 'I love tandem!', wysiwyg: true)
